...
for i in /opt/slurm/software/bin/sacct           /opt/slurm/software/bin/sacctmgr           /opt/slurm/software/bin/salloc           /opt/slurm/software/bin/sattach           /opt/slurm/software/bin/sbang           /opt/slurm/software/bin/sbatch           /opt/slurm/software/bin/sbcast           /opt/slurm/software/bin/scancel           /opt/slurm/software/bin/scontrol           /opt/slurm/software/bin/scrontab           /opt/slurm/software/bin/sdiag           /opt/slurm/software/bin/sh5util           /opt/slurm/software/bin/sinfo           /opt/slurm/software/bin/sprio           /opt/slurm/software/bin/squeue           /opt/slurm/software/bin/sreport           /opt/slurm/software/bin/srun           /opt/slurm/software/bin/sshare           /opt/slurm/software/bin/sstat           /opt/slurm/software/bin/strigger           /opt/slurm/software/sbin/slurmctld           /opt/slurm/software/sbin/slurmd           /opt/slurm/software/sbin/slurmdbd           /opt/slurm/software/sbin/slurmrestd           /opt/slurm/software/sbin/slurmstepd; do
