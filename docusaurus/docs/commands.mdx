...
│ slurm-lxd-localhost         Commands for slurm-lxd-localhost.                                                                                                                                        │
...
│    --app                  [slurm-lxd-localhost|slurm-microk8s-localhost|slurm-multipass-localhost]  Deploy an application after cluster creation.                                                    │
│    --json         -j                                                                                Output in JSON format                                                                            │
│    --verbose      -v                                                                                Enable verbose terminal output                                                                   │
│    --profile      -p      TEXT                                                                      Profile name to use [default: default]                                                           │
│    --help                                                                                           Show this message and exit.                                                                      │
