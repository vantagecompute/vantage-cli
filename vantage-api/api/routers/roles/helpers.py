"""Helper functions for the roles router."""
from typing import Optional

from fastapi import HTTPException, status

from api.body.output import RoleModel, UserModel
...
class ListRolesSortFieldChecker:
...
class ListUsersByRoleSortFieldChecker:
