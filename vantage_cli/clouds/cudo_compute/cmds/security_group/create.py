...
"""Create Cudo Compute security group command."""
...
async def create_security_group(
    ...
    security_group_id: str = typer.Argument(..., help="Unique security group identifier"),
    description: str = typer.Option(None, "--description", help="Security group description"),
) -> None:
    """Create a new Cudo Compute security group."""
    ...
    try:
        ...
        logger.debug(f"[bold green]Success:[/bold green] Created security group '{security_group_id}'")
