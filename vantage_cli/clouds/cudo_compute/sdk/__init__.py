...
class CudoComputeSDK:
    ...
    async def get_machine_type(
        ...
        for mt in machine_types:
            if mt.get("dataCenterId") == data_center_id and mt.get("id") == machine_type_id:
                return mt
        
        # Not found - raise a 404-like error
        from httpx import HTTPStatusError, Response, Request
        request = Request("GET", f"/v1/machines-types?dataCenterId={data_center_id}&id={machine_type_id}")
