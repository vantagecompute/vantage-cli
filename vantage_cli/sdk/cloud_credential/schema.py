...
def save_credentials(credentials_data: Dict[str, Any]) -> None:
    ...
    try:
        ...
        CREDENTIALS_YAML.write_text(yaml.dump(credentials_data, default_flow_style=False, indent=2))
...
class CloudCredential(BaseModel):
    ...
    cloud_id: str = Field(
        ...,
        description="ID of the associated cloud"
    )
    ...
    default: bool = Field(
        default=False,
        description="Whether this is the default credential for this cloud type"
    )
